 ...
 * @project JS Beautify Safari Extension (https://github.com/spadin/js-beautify-safari-extension)
 * @version 1.3
 ***************************************/
...
r=g="";e=[];H=false;M="\n\r\t ".split("");I="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_$".split("");S="0123456789".split("");O="+ - * / % & ++ -- = += -= *= /= %= == === != !== > < >= <= >> << >>> >>>= >>= <<= && &= | || ! !! , : ? ^ ^= |= ::".split(" ");z="continue,try,throw,return,var,if,switch,case,default,for,while,break,function".split(",");E=[];w("BLOCK");for(b=0;;){A=L(b);k=A[0];A=A[1];if(A==="TK_EOF")break;switch(A){case "TK_START_EXPR":if(k==="["){if(d==="TK_WORD"||g===
